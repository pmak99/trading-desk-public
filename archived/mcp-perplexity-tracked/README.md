...
```bash
/Users/prashant/PycharmProjects/Trading Desk/2.0/venv/bin/pip install mcp httpx
```
...
```json
{
  "mcpServers": {
    "perplexity": {
      "type": "stdio",
      "command": "/Users/prashant/PycharmProjects/Trading Desk/2.0/venv/bin/python",
      "args": [
        "/Users/prashant/PycharmProjects/Trading Desk/mcp-servers/perplexity-tracked/server.py"
      ],
      "env": {
        "PERPLEXITY_API_KEY": "pplx-xxx...your-key-here",
        "BUDGET_DB_PATH": "/Users/prashant/PycharmProjects/Trading Desk/4.0/data/sentiment_cache.db"
      }
    }
  }
}
