...
This agent implements guardrails to prevent costly mistakes from trading an
EXCELLENT VRP + REJECT liquidity conflict.
"""
        ...
        if recommendation == 'EXCELLENT' and liquidity_tier == 'REJECT':
            return {
                ...
                'message': (
                    ...
                    f"DO NOT TRADE (learned from a costly real-world loss)"
                )
            }
