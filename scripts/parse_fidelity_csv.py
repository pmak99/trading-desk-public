...
def main():
    ...
    parser.add_argument('--db', default='/Users/prashant/PycharmProjects/Trading Desk/2.0/data/ivcrush.db',
                       help='Path to ivcrush database for VRP correlation')
    parser.add_argument('--output', default='/Users/prashant/PycharmProjects/Trading Desk/docs/2025 Trades',
