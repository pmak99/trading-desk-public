...
```bash
cd "/Users/prashant/PycharmProjects/Trading Desk/2.0" && ./trade.sh scan $(date +%Y-%m-%d) 2>&1 | "/Users/prashant/PycharmProjects/Trading Desk/2.0/venv/bin/python" "/Users/prashant/PycharmProjects/Trading Desk/scripts/export_scan_results.py"
```
...
```bash
sqlite3 -header -csv "/Users/prashant/PycharmProjects/Trading Desk/2.0/data/ivcrush.db" \
...
sqlite3 -header -csv "/Users/prashant/PycharmProjects/Trading Desk/2.0/data/ivcrush.db" \
  "SELECT symbol, strategy_type, acquired_date, sale_date, days_held,
          gain_loss, is_winner, trade_type, campaign_id, trr_at_entry
   FROM strategies
   ORDER BY sale_date DESC;" > "/Users/prashant/PycharmProjects/Trading Desk/2.0/docs/scan_exports/strategies_$(date +%Y%m%d).csv"
```
...
sqlite3 -header -csv "/Users/prashant/PycharmProjects/Trading Desk/2.0/data/ivcrush.db" \
  "SELECT symbol,
   ...
   ORDER BY total_pnl DESC;" > "/Users/prashant/PycharmProjects/Trading Desk/2.0/docs/scan_exports/performance_$(date +%Y%m%d).csv"
```
...
sqlite3 -header -csv "/Users/prashant/PycharmProjects/Trading Desk/2.0/data/ivcrush.db" \
  "SELECT s.symbol, s.strategy_type, s.acquired_date, s.sale_date,
   ...
   ORDER BY s.sale_date DESC;" > "/Users/prashant/PycharmProjects/Trading Desk/2.0/docs/scan_exports/${TICKER}_trades_$(date +%Y%m%d).csv"
```
...
sqlite3 -header -csv "/Users/prashant/PycharmProjects/Trading Desk/2.0/data/ivcrush.db" \
  "SELECT * FROM historical_moves
   WHERE ticker='$TICKER'
   ORDER BY earnings_date DESC;" > "/Users/prashant/PycharmProjects/Trading Desk/2.0/docs/scan_exports/${TICKER}_history_$(date +%Y%m%d).csv"
```
