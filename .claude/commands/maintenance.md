...
```bash
BACKUP_DIR="/Users/prashant/PycharmProjects/Trading Desk/2.0/backups"
DB_FILE="/Users/prashant/PycharmProjects/Trading Desk/2.0/data/ivcrush.db"
...
```bash
BACKUP_DIR="/Users/prashant/PycharmProjects/Trading Desk/4.0/backups"
mkdir -p "$BACKUP_DIR"
DB_FILE="/Users/prashant/PycharmProjects/Trading Desk/4.0/data/sentiment_cache.db"
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
