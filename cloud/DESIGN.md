...
Cloud "Autopilot" transforms the IV Crush trading system from manual CLI commands into a 24/7 cloud-native service that:
...
- **Maintains** all core VRP math and trading logic from core
...
│
├── domain/                   # Business logic (ported from core)
│   ├── __init__.py
...
1. Port VRP calculation from core
