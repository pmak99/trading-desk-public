...
This meant the -significant loss analysis and weight rebalancing had **ZERO IMPACT** on actual strategy selection.
...
After -significant loss from WDAY/ZS/SYM, scoring weights were rebalanced
...
**Impact:** Would have prevented ~50% of losses (-significant → ~-$13,000).
...
- **TRUE_PL_ANALYSIS.md:** Root cause showing -significant to -significant TRUE loss
