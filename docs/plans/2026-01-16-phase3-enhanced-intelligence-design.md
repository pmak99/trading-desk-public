...
Surface existing TRR data in whisper/analyze output to prevent oversizing on high-risk tickers. Learned from a real high-TRR single-trade loss in December 2025.
