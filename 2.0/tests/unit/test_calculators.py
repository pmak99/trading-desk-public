...
class TestVRPCalculator:
    ...
    def test_calculate_excellent_vrp(self):
        ...
        historical_moves = [
            HistoricalMove(
                ticker=ticker,
                earnings_date=date(2026, 6, 16) - timedelta(days=90 * i),
        ...
        # MARGINAL is tradeable (at 50% reduced size) per CLAUDE.md's VRP
        # tier table -- only SKIP (<1.2x) means don't trade.
