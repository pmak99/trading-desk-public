...
**Goal:** Optimize scoring weights (VRP, Consistency, Skew, Liquidity) to maximize risk-adjusted returns on a $600K account.
...
**Projected Performance on $600K Account:**
- Monthly P&L: $7,689
...
**Implication:** For $600K account, ~4-5 trades per year is optimal. This aligns with actual trading patterns observed (65 positions over 90 days = ~0.7/day was TOO FREQUENT and led to tail risk).

---

## Position Sizing for $600K Account
...
2. **Implement Position Size Limits**
   - Iron Condors: $30,000 max risk (5% of $600K)
...
**Critical Rules for $600K Account:**
...
**Recommended Action:** Deploy **Consistency-Heavy** configuration on $600K account with strict position sizing and risk management.
