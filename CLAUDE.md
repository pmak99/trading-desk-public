...
Added after December 2025 MU $134k single-trade loss. Notable HIGH TRR: MU (3.05x), DRI (6.96x), GME (5.44x), NKE (4.89x).
...
**Location:** `2.0/data/ivcrush.db` (local), `gs://trading-desk-data/ivcrush.db` (cloud)
